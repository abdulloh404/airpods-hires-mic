...
function App() {
  ...
  }, [loadSettings, refreshStatus, scanBattery]);
      ...
      <main className="app-shell">
        <header className="topbar">
          ...
          <div className="header-actions">
            ...
            <button className={`icon-button ${scanning ? "spin" : ""}`} aria-label="Refresh" disabled={loading || scanning} onClick={() => { void refreshStatus(); void scanBattery(); }}>↻</button>
          </div>
        </header>
        ...
        <div className="lower-grid">
          <section className="settings-panel panel">
            ...
            <div className="settings-actions"><button className="reset-button" disabled={busy} onClick={() => setSettings(defaultSettings)}>Default</button><button className="save-button" disabled={busy} onClick={() => void saveSettings()}>{saved ? "Saved ✓" : serviceActive ? "Save & restart" : "Save settings"}</button></div>
          </section>
